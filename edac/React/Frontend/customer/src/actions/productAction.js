...
export const getAllProductsByPid=(productId)=>dispatch=>{   
    ...
    axios.post(url +'/api/products/getallproductsbyid',{productId}).then(res => {
...
export const getProductById=(product_ids)=>dispatch=>{   
    ...
    axios.post(url +'/api/products/getproductbyid',product_ids).then(res => {
...
export const getLatestMobiles=()=>(dispatch)=>{
    ...
    axios.get(url +'/api/products/getlatestmobiles').then(res=>{
...
export const getLatestEarphones=()=>(dispatch)=>{
    ...
    axios.get(url +'/api/products/getlatestearphones').then(res=>{
